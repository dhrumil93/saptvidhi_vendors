  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.cardPreview}>
        <Image
          source={{
            uri: "https://images.unsplash.com/photo-1521587760476-6c12a4b040da?q=80&w=2787",
          }}
      ...
      <View style={styles.bottomActions}>
        ...
        <View style={styles.editTools}>
          ...
          <TouchableOpacity style={styles.toolButton}>
            <Ionicons name="arrow-undo-outline" size={24} color="#666" />
...
export default CustomizeCardPage;
